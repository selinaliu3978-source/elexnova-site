...
function Get-SeoIntro([string]$slug, [string]$title, [string[]]$keywords) {
  ...
  return "$summary $title products are designed for B2B engineers, purchasing teams and product development managers who need reliable magnetic components for power supplies, EV charging equipment, renewable energy converters, industrial control systems, communication devices, LED drivers and custom electronic assemblies. Buyers can review physical construction, mounting format, winding style, core type and application fit before sending an RFQ. MiDEN Electronics supports technical discussions covering inductance value, rated current, saturation current, frequency range, temperature rise, insulation requirements, mechanical dimensions, sample matching and drawing review. The product gallery helps buyers compare proportions, lead styles, winding density, core geometry and assembly formats before requesting samples, drawings or a quotation. If a standard product does not meet the target requirement, MiDEN can discuss customized magnetic components, including alternative core materials, winding changes, insulation class, mounting methods and production quantity planning. Buyers can also compare related product families below or contact the sales team by RFQ, email or WhatsApp. ElexNova supplies these magnetic component solutions for global industrial sourcing projects, with products manufactured by MiDEN Electronics."
}
...
<main><section class="page-hero"><p class="eyebrow">Products</p><h1>Magnetic Components for Industrial Power Electronics</h1><p>Explore inductors, transformers, chokes and custom magnetic components manufactured by MiDEN Electronics for industrial power conversion, filtering and control applications.</p></section><section class="section product-catalog" aria-labelledby="product-catalog-title"><div class="section-head"><p class="eyebrow">Product Categories</p><h2 id="product-catalog-title">Find the right magnetic component</h2><p>Compare product construction and application fit, then contact our team for samples, drawings, technical review or a quotation.</p></div><div id="product-catalog-sections" class="product-catalog-sections"></div></section></main>
$(Footer '')
$productsScript
...
<body>
$(Header '../' $folderCategories)
<main><section class="page-hero"><nav class="breadcrumbs" aria-label="Breadcrumb"><a href="../index.html">Home</a><span>Products</span></nav><p class="eyebrow">Products</p><h1>Magnetic Components</h1><p>Explore MiDEN Electronics product categories for industrial power conversion, filtering and control applications.</p><div class="actions"><a class="btn" href="../products.html">Open Product Catalog</a></div></section></main>
$(Footer '../')
...
& (Join-Path $PSScriptRoot 'inject-product-technical-specs.ps1')
